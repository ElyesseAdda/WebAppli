#!/usr/bin/env python
"""
Script de debug pour vérifier l'import du pdf_manager
"""
...
print("🔍 DEBUG: Vérification de l'import du pdf_manager")
print("=" * 50)
...
try:
    ...
    print(f"📋 Méthodes disponibles: {[method for method in dir(pdf_manager) if not method.startswith('_')]}")
