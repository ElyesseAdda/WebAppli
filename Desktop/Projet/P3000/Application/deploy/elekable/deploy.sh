#!/usr/bin/env bash
# =============================================================================
# deploy/elekable/deploy.sh — Déploiement complet Elekable
# =============================================================================
# À exécuter sur le SERVEUR ELEKABLE en tant que root ou sudo
#
# Usage :
#   bash /var/www/elekable/Desktop/Projet/P3000/Application/deploy/elekable/deploy.sh
#   ou via alias :
#   elekable-deploy
# =============================================================================
