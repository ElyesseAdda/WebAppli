#!/usr/bin/env bash
# =============================================================================
# deploy/mjrservice/setup-aliases.sh — Configure les alias sur le serveur MJRService
# =============================================================================
# À exécuter UNE SEULE FOIS sur le serveur MJRService après installation.
...
SERVICE="${CLIENT_NAME}"
DEPLOY_SCRIPT="${APP_DIR}/deploy/mjrservice/deploy.sh"
RESTART_SCRIPT="${APP_DIR}/deploy/mjrservice/restart.sh"
BASHRC="$HOME/.bashrc"
...
echo ""
echo "   ⚠️  Pour que 'mjrservice-go' fonctionne dans votre shell actuel :"
echo "   source ~/.bashrc"
echo ""
