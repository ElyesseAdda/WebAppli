# Generated by Django 5.1.1 on 2025-02-16 15:20
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('cumul_mois_precedent', models.DecimalField(decimal_places=2, default=0, max_digits=10)),
                ('montant_total_mois_apres_retenue', models.DecimalField(decimal_places=2, default=0, max_digits=10)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('situation', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='situation_lignes', to='api.situation')),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('situation', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='situation_lignes_avenants', to='api.situation')),
            ],
            options={
                'ordering': ['id'],
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('situation', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='situation_lignes_supplementaires', to='api.situation')),
            ],
            options={
                'ordering': ['id'],
            },
        ...
        migrations.AlterUniqueTogether(
            name='situation',
            unique_together={('chantier', 'numero_situation')},
        ),
    ]
