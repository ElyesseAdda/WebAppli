# Generated by Django 5.1.1 on 2025-02-15 13:00
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('chantier', models.ForeignKey(default='', on_delete=django.db.models.deletion.CASCADE, related_name='situations', to='api.chantier')),
            ],
            options={
                'ordering': ['numero'],
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('facture_ts', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='api.facturets')),
        ...
        migrations.AddConstraint(
            ...
            constraint=models.CheckConstraint(condition=models.Q(models.Q(('facture_ts__isnull', True), ('ligne_devis__isnull', False)), models.Q(('facture_ts__isnull', False), ('ligne_devis__isnull', True)), _connector='OR'), name='one_line_type_only'),
        ),
    ]
