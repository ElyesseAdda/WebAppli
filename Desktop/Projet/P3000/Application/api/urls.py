...
urlpatterns = [
    ...
    path('get-next-facture-number/', get_next_facture_number, name='get_next_facture_number'),
    path('generate-facture-pdf-from-preview/', generate_facture_pdf_from_preview, name='generate_facture_pdf_from_preview'),
    ...
    path('chantiers/drive-paths/', get_chantiers_drive_paths, name='chantiers-drive-paths'),
    ...
    path('situations/<int:situation_id>/previous/', get_previous_situation, name='get-previous-situation'),
    ...
    path('ajustement-agent-journalier/', ajustement_agent_journalier, name='ajustement-agent-journalier'),
...
urlpatterns += [
    ...
    path('drive-v2/folder-download-manifest/', DriveV2ViewSet.as_view({
        'get': 'folder_download_manifest'
    }), name='drive-v2-folder-download-manifest'),
    path('drive-v2/stream-file/', DriveV2ViewSet.as_view({
        'get': 'stream_file'
    }), name='drive-v2-stream-file'),
