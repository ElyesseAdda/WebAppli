...
from .views import (
    ...
    create_facture_from_devis, get_next_facture_number, check_facture_numero, generate_facture_pdf_from_preview, get_chantier_details, check_chantier_name, check_client, check_societe,
