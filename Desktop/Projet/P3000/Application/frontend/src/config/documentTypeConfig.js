...
export const DOCUMENT_CONFIG = {
  [DOCUMENT_TYPES.SITUATION]: {
    ...
    buildParams: (documentData) => ({
      ...
      chantier_name: documentData.chantier?.chantier_name || documentData.chantier_name || 'Chantier',
      societe_name: documentData.chantier?.societe?.nom_societe || documentData.societe_name || 'Société',
  ...
  [DOCUMENT_TYPES.AVENANT_SOUS_TRAITANCE]: {
    ...
    buildParams: (documentData) => ({
      ...
      chantier_name: documentData.chantier?.chantier_name || documentData.chantier_name || documentData.contrat?.chantier?.chantier_name || 'Chantier',
      societe_name: documentData.chantier?.societe?.nom_societe || documentData.societe_name || documentData.contrat?.chantier?.societe?.nom_societe || 'Société',
