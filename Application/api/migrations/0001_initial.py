    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('phone_Number', models.IntegerField()),
                ('chantiers', models.ManyToManyField(blank=True, related_name='client', to='api.chantier')),
            ],
        ),
        migrations.CreateModel(
            name='Devis',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('partie', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='api.partie')),
            ],
        ),
        migrations.CreateModel(
            name='DevisItem',
